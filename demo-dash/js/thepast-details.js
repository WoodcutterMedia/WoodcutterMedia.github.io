...
Highcharts.chart('thepast-youtube', {
    chart: {
        type: 'line',
...
Highcharts.chart('thepast-facebook', {
    chart: {
        type: 'line',
        backgroundColor: 'rgba(255, 255, 255, 0.0)'
    },
...
Highcharts.chart('thepast-twitter', {
    chart: {
        type: 'line',
        backgroundColor: 'rgba(255, 255, 255, 0.0)'
    },
...
// thepast Search
// Highcharts.chart('thepast-search', {
//     chart: {
//         type: 'column'
//     },
//     data: {
//         // enablePolling: true,
//         csvURL: window.location.origin + 'data/thepast.csv'
//     },
//     title: {
...
Highcharts.chart('thepast-search', {
    ...
    series: [{
        ...
        showInLegend: true,
        data: [
            20, 17, 17, 9, 26, 9, 51, 20, 35, 18, 9, 26, 9, 21, 40, 9, 35, 52, 27, 100, 92, 81, 9, 60, 61, 80
        ],
...
Highcharts.chart('thepast-allsocial', {
    chart: {
        type: 'line',
